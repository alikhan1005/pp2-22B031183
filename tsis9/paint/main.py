...
def setsurf():
    ...
    tr1 = pg.image.load("/Users/alikhankudaibergen/Documents/pp2/tsis9/paint/images/right_triangle.png")
    buttons.blit(tr1, (8, 8))
    tr2 = pg.image.load("/Users/alikhankudaibergen/Documents/pp2/tsis9/paint/images/equilateral-triangle.png")
    buttons.blit(tr2, (8, 55))
    pg.draw.rect(buttons, 'black', (58, 10, 32, 32), 2)
    rh = pg.image.load("/Users/alikhankudaibergen/Documents/pp2/tsis9/paint/images/rhombus.png")
