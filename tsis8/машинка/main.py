...
car_enemy = pygame.image.load('/Users/alikhankudaibergen/Documents/pp2/tsis8/машинка/greencar.png')
car_Own = pygame.image.load('/Users/alikhankudaibergen/Documents/pp2/tsis8/машинка/redcar.png')
bg = pygame.image.load("/Users/alikhankudaibergen/Documents/pp2/tsis8/машинка/AnimatedStreet.png")
...
class coin_generation(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.img = pygame.transform.scale(pygame.image.load('/Users/alikhankudaibergen/Documents/pp2/tsis8/машинка/coin.png'), (40,40))
...
class ownMovement(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.car = pygame.transform.scale(pygame.image.load('/Users/alikhankudaibergen/Documents/pp2/tsis8/машинка/redcar.png'), (40, 90))
...
class enemyMovement(pygame.sprite.Sprite):
        def __init__(self):
            super().__init__()
            self.car = pygame.transform.scale(pygame.image.load('/Users/alikhankudaibergen/Documents/pp2/tsis8/машинка/greencar.png'), (45, 90))
            self.rect = self.car.get_rect()
...
while 1:
    ...
    scoreeee = f'collected coins - {coins}'      # вывод на экран
    ...
    if pygame.sprite.spritecollideany(current_Own, sprite_Enemy):
        pygame.display.update()
        pygame.mixer.Sound('/Users/alikhankudaibergen/Documents/pp2/tsis8/машинка/crash.mp3').play()
